 ...
 * Copyright (c) eHealth
 */
package be.jeremy.pascal.ci;

import be.jeremy.pascal.ci.backend.Backend;
import be.jeremy.pascal.ci.backend.BackendFactory;
import be.jeremy.pascal.ci.frontend.FrontendFactory;
...
import be.jeremy.pascal.ci.message.MessageType;
